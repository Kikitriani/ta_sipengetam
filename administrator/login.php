...
<head>
  ...
  <!-- Favicon icon -->
  <!-- <link rel="icon" href="assets/img/logo-kemenkeu.png" type="image/x-icon" /> -->
...
<body class="login">
  ...
  <div class="wrapper wrapper-login">
    <div class="container container-login animated fadeIn">
      <!-- logo -->
      <div class="text-center mb-4"><img src="assets/img/SI Pengetam.png" alt="Logo" width="200"></div>
      <!-- judul -->
      <h3 class="text-center">Sistem Informasi<br> Pengelolaan Hutan Mangrove</h3>
      <!-- form login -->
      <form action="proses_login.php" method="post" class="needs-validation" novalidate>
        ...
        <div class="form-action mt-2">
            <!-- tombol login -->
            <button type="submit" name="login" class="btn btn-success btn-rounded btn-login btn-block pt-2 pb-2">
                <span style="font-size:15pt;"><i class="fas fa-sign-in-alt"></i>  LOGIN</span>
            </button>
        ...
        <div class="login-footer mt-4">
          <span class="msg">&copy; <?php echo date("Y");?> -</span>
          <a href="#" target="_BLANK" class="text-success">SI Pengetam</a>.
        </div>
      </form>
    </div>
  </div>
