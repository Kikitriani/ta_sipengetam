    ...
    <div class="page-inner py-45">
      <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
        ...
        <div class="ml-md-auto py-2 py-md-0">
          <!-- tombol entri data -->
          <a href="?module=form_entri_user" class="btn btn-success btn-round mr-2">
        ...
        <div class="table-responsive">
          ...
          <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              $query = mysqli_query($mysqli, "SELECT * FROM tbl_user a LEFT JOIN tbl_tempat b ON a.id_tempat=b.id_tempat ORDER BY a.id_user DESC")
                ...
                <tr>
                  ...
                  <td width="100"><?php 
                        if($data['hak_akses']=="Super Admin") {
                            echo "<span class='badge badge-success'>".$data['hak_akses']."</span><br>".$data['nama_tempat'];
                        }elseif($data['hak_akses']=="Administrator"){
                            echo "<span class='badge badge-primary'>".$data['hak_akses']."</span><br>".$data['nama_tempat'];
                        }?>
                  </td>
                  <td width="70" class="text-center">
                    ...
                    <div>
                      <!-- tombol ubah data -->
                      <a href="?module=form_ubah_user&id=<?php echo $data['id_user']; ?>" class="btn btn-icon btn-round btn-info btn-sm mr-md-1" data-toggle="tooltip" data-placement="top" title="Ubah">
