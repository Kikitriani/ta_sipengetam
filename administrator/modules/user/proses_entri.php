...
// jika user sudah login, maka jalankan perintah untuk insert
  ...
  if (isset($_POST['simpan'])) {
    ...
    $id_tempat = mysqli_real_escape_string($mysqli, trim($_POST['id_tempat']));
    ...
    // jika "username" belum ada di tabel "tbl_user"
      ...
      $insert = mysqli_query($mysqli, "INSERT INTO tbl_user(nama_user, username, password, hak_akses, id_tempat)
                                       VALUES('$nama_user', '$username', '$password_hash', '$hak_akses', '$id_tempat')")
