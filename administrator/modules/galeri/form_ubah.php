...
// jika file di include oleh file lain, tampilkan isi file
  ...
  if (isset($_GET['id'])) {
    ...
    // sql statement untuk menampilkan data dari tabel "tbl_user" berdasarkan "id_galeri"
    $query = mysqli_query($mysqli, "SELECT * FROM tbl_galeri WHERE id_galeri='$id_galeri'")
  ...
  <div class="panel-header bg-success-gradient">
    <div class="page-inner py-4">
      <div class="page-header text-white">
        <!-- judul halaman -->
        <h4 class="page-title text-white"><i class="fas fa-file-pdf mr-2"></i></i> Galeri</h4>
        <!-- breadcrumbs -->
  ...
  <div class="page-inner mt--5">
    <div class="card">
      <div class="card-header">
        <!-- judul form -->
        <div class="card-title">Ubah Galeri</div>
      </div>
      <!-- form entri data -->
      <form action="modules/galeri/proses_ubah.php" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
        <div class="card-body">  
          <div class="row">
            <div class="col-sm-6">
              <input type="text" value="<?=$data['id_galeri']?>" name="id_galeri" hidden>
              <div class="form-group">
                ...
                <div class="invalid-feedback">Nama Tempat tidak boleh </div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
